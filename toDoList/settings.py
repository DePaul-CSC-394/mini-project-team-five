...
# SECRET_KEY = 'django-insecure-if0s2)3!3seto^dqxrm!fpe1lutbnb5j2i1guv++cul=56&*ee'

# # SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True

# ALLOWED_HOSTS = []
### Default code replaced with new code below vvv
# SECURITY WARNING: keep the secret key used in production secret!
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "teamfivebestteam@gmail.com"
EMAIL_HOST_PASSWORD = "nkqc zwnb tgfh msxt"